...
//go:generate go run ../../cmd/migrator --migrations-path=../../migrations
//go:generate go run ../../cmd/migrator --migrations-path=./migrations --migrations-table=migrations_test
